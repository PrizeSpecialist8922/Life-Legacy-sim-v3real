...
export interface JobDef {
  ...
  minFitness?: number; // e.g. professional athletes
  minSmarts: number;
  minAge: number;
...
export const JOBS: JobDef[] = [
  ...
  },
  {
    ...
    company: "Deloitte & Marsh",
    field: "Accounting",
    baseSalary: 62000,
    requiresDegree: true,
    minSmarts: 55,
    minAge: 22,
    ladder: ["Staff Accountant", "Senior Accountant", "Manager", "Senior Manager", "Partner"],
  },
  {
    id: "engineer",
    title: "Junior Engineer",
    company: "Vertex Engineering Group",
    field: "Engineering",
    baseSalary: 74000,
    requiresDegree: true,
    minSmarts: 65,
  ...
  },
  {
    ...
    minSmarts: 60,
    minAge: 25,
    ladder: ["City Councillor", "Mayor", "State Legislator", "Senator"],
  },
  {
    id: "athlete",
    title: "Rookie Athlete",
    company: "Professional League",
    field: "Athletics",
    baseSalary: 120000,
    requiresDegree: false,
    minFitness: 80,
    minSmarts: 20,
    minAge: 18,
    ladder: ["Rookie Athlete", "Starter", "All-Star", "Franchise Player"],
  },
  {
    id: "founder",
    ...
    minSmarts: 60,
    minAge: 18,
    ladder: ["Startup Founder", "Funded Founder", "Growth-Stage CEO", "Unicorn CEO"],
  },
  {
    id: "entertainer",
    title: "Aspiring Performer",
    company: "Independent",
    field: "Entertainment",
    baseSalary: 24000,
    requiresDegree: false,
    minSmarts: 30,
    minAge: 16,
    ladder: ["Aspiring Performer", "Working Performer", "Headliner", "Superstar"],
  },
  {
    id: "marketer",
